		  ...
		  <div class="row">
		    ...
		    <div class="collapse navbar-collapse center-links" id="bs-example-navbar-collapse-1">
			    <ul class="nav navbar-nav pull-right">		      	
			        <li class="active color-link nav-text"><a href="{{ url('/inicio') }}"><b>Inicio</b> <span class="sr-only">(current)</span></a></li>	

			    <div class="dropdown pull-right color-link nav-text">
					  <button style="background-color: #1b1b1b; color: #FFFFFF; border: none; padding-top: 13px;" class="btn btn-default dropdown-toggle color-link nav-text" type="button" id="dropdownCanchas" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
					    <b>Promociones</b>
			    ...
			    <div class="dropdown pull-right color-link nav-text">
					  ...
					  <ul style="background-color: #1b1b1b;" class="dropdown-menu" aria-labelledby="dropdownCanchas">
					    <li class="color-link nav-text hov"><a style="color: #FFFFFF" href="{{ url('/canchas') }}"><b>Mostrar</b></a></li>
					   {{--  <li class="color-link nav-text hov"><a style="color: #FFFFFF" href="{{ url('/agregarcanchas') }}"><b>Agregar</b></a></li> --}}
					    {{-- <li class="color-link nav-text hov"><a style="color: #FFFFFF" href="{{ url('/modificarcanchas') }}"><b>Modificar</b></a></li>
					    <li class="color-link nav-text hov"><a style="color: #FFFFFF" href="{{ url('/eliminarcanchas') }}"><b>Eliminar</b></a></li> --}}
					  </ul>
				</div>   	
